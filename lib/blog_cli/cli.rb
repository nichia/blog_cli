class BlogCLI::CLI
  ...
  def post_index
    ...
    # This is bad
    #Post.find_by(:author_id => current_user.id)
  ...
  def post_new
    ...
    #post = BlogCLI::Post.new(params) # Mass Assisgnment
    #post.title = user_input # Attribute assignment on an AR Instance
    #post.content = user_input # Attribute assignment hipsum Ipsum, lorem Ipsum, other Ipsum

    # How can I assoiate this blog post with author?
    # In 2 ways:
    # 1. Let's manually assign the current_user as the author to this post
    ...
    # 2. Let's actually instantiate the post already associated with the current_user
